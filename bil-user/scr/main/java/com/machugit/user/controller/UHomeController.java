...
@Validated
public class UHomeController extends com.machugit.controller.ABaseController {
    ...
    public ResponseVO updateUserInfo(String useName,
        ...
        if (updated != null && esSearchService != null) esSearchService.indexUser(updated);
    ...
    public ResponseVO searchUsers(@NotEmpty String keyword) {
        List<UserDoc> docs = null;
        if (esSearchService != null) {
            docs = esSearchService.searchUser(keyword, 0, 20);
        }
